    ...
    public static abstract class Callback implements IBinder.DeathRecipient {
        ...
        private class StubCompat extends IMediaControllerCallback.Stub {
            ...
            public void onCaptioningEnabledChanged(boolean enabled) throws RemoteException {
                Callback.this.mHandler.post(11, Boolean.valueOf(enabled), (Bundle) null);
            }
    ...
    static class MediaControllerImplApi21 implements MediaControllerImpl {
        ...
        public final void registerCallback(android.support.v4.media.session.MediaControllerCompat.Callback r5, android.os.Handler r6) {
            /*
                ...
                android.support.v4.media.session.IMediaSession r1 = r4.mExtraBinder     // Catch:{ RemoteException -> 0x0023 }
                r1.registerCallbackListener(r0)     // Catch:{ RemoteException -> 0x0023 }
                goto L_0x002b
            L_0x0023:
                r1 = move-exception
            ...
            L_0x002c:
                ...
                monitor-enter(r0)
                java.util.List<android.support.v4.media.session.MediaControllerCompat$Callback> r1 = r4.mPendingCallbacks     // Catch:{ all -> 0x0039 }
        ...
        public final void unregisterCallback(android.support.v4.media.session.MediaControllerCompat.Callback r4) {
            /*
                ...
                android.support.v4.media.session.MediaControllerCompat$MediaControllerImplApi21$ExtraCallback r0 = (android.support.v4.media.session.MediaControllerCompat.MediaControllerImplApi21.ExtraCallback) r0     // Catch:{ RemoteException -> 0x001d }
