    ...
    public void draw(Canvas canvas) {
        ...
        if (this.mRunning || this.mFinishTime > 0) {
            ...
            if (rawProgress < 0.0f || rawProgress > 25.0f) {
                ...
                long j2 = elapsed;
                drawCircle(canvas2, (float) cx, (float) cy, this.mColor1, ((rawProgress + 25.0f) * 2.0f) / 100.0f);
            }
            if (rawProgress >= 0.0f && rawProgress <= 50.0f) {
                drawCircle(canvas2, (float) cx, (float) cy, this.mColor2, (rawProgress * 2.0f) / 100.0f);
            }
