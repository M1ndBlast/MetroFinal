...
public class DrawerArrowDrawable extends Drawable {
    ...
    public void draw(Canvas canvas) {
        ...
        float f2 = arrowHeight;
        float f3 = topBottomBarOffset;
        float f4 = arrowShaftLength;
        float f5 = arrowShaftCut;
        float f6 = rotation;
        canvas2.translate((float) bounds.centerX(), (float) (((double) ((float) ((((int) ((((float) bounds.height()) - (3.0f * barThickness)) - (this.mBarGap * 2.0f))) / 4) * 2))) + (((double) barThickness) * 1.5d) + ((double) this.mBarGap)));
        if (this.mSpin) {
