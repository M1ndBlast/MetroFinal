package org.no_ip.payan.metrofinal.clases;
...
public class MCReader {
    ...
    public static Tag patchTag(Tag tag) {
        ...
        tag2.writeToParcel(oldParcel, 0);
        ...
        Tag newTag = (Tag) Tag.CREATOR.createFromParcel(newParcel);
        newParcel.recycle();
        return newTag;
    }
    ...
    public String[] readSector(int sectorIndex, byte[] key, boolean useAsKeyB) throws TagLostException {
        ...
        while (i < lastBlock) {
            try {
                ...
                blocks.add(util.byte2HexString(blockBytes));
                i++;
            } catch (TagLostException e) {
                throw e;
        ...
        if (!useAsKeyB) {
            if (isKeyBReadable(util.hexStringToByteArray(ret[last].substring(12, 20)))) {
                ret[last] = util.byte2HexString(key) + ret[last].substring(12, 32);
                return ret;
            }
            ret[last] = util.byte2HexString(key) + ret[last].substring(12, 20) + NO_KEY;
            return ret;
        } else if (ret[0].equals(NO_DATA)) {
            return null;
        } else {
            ret[last] = NO_KEY + ret[last].substring(12, 20) + util.byte2HexString(key);
            return ret;
        }
    }
    ...
    public java.lang.String[] mergeSectorData(java.lang.String[] r9, java.lang.String[] r10) {
        /*
            r8 = this;
            r0 = 0
        ...
        L_0x00c1:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: org.no_ip.payan.metrofinal.clases.MCReader.mergeSectorData(java.lang.String[], java.lang.String[]):java.lang.String[]");
    }
    ...
    public boolean setKeys() {
        ...
        if (lines != null) {
            ...
            while (i < length) {
                try {
                    keys.add(util.hexStringToByteArray(lines[i]));
                    i++;
        ...
        if (lines != null) {
            for (String line : lines) {
                if (!line.equals("") && line.length() == 12 && line.matches("[0-9A-Fa-f]+")) {
                    try {
                        keys.add(util.hexStringToByteArray(line));
                    } catch (OutOfMemoryError e) {
                        return false;
                    }
                }
    ...
    private boolean authenticate(int sectorIndex, byte[] key, boolean useAsKeyB) {
        ...
        if (!useAsKeyB) {
            try {
                ...
                return this.mMFC.authenticateSectorWithKeyA(sectorIndex, key);
            } catch (IOException e2) {
